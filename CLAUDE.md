...
- `docs/DESIGN.md` - the design system, and the rules that are enforced in tests.
- `docs/DESIGN_REVIEW.md` - the whole-app design review, its scores and findings.
...
3. wrangler OAuth expires: `npx wrangler whoami` clears transient 7403; `npx wrangler login` for full re-auth. Account: `<your Cloudflare account id>` (from `wrangler whoami`).
